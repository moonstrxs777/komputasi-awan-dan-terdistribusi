...
|---|---|---|---|---|
| 17 September 2026 | ChatGPT | Membantu menganalisis Pitfall 2 The Network is Reliable pada kasus FoodGo berdasarkan skenario yang diberikan. | AI membantu menjelaskan hubungan antara asumsi bahwa jaringan selalu reliable dengan tidak adanya retry dan timeout pada komunikasi antar-service. AI juga memberikan gambaran solusi seperti timeout, retry dengan exponential backoff, dan circuit breaker beserta trade-off-nya. | Saran AI digunakan sebagai bahan pemahaman dan kerangka awal. Analisis kemudian disesuaikan dengan skenario FoodGo dan ditulis kembali menggunakan bahasa sendiri, terutama pada bagian dampak, solusi, dan trade-off. |
| 17 September 2026 | ChatGPT | Membantu menganalisis Pitfall 3 Single Point of Failure pada kasus FoodGo berdasarkan skenario yang diberikan. | AI membantu mengidentifikasi bahwa satu server yang menangani modul pesanan, pembayaran, dan notifikasi dapat menjadi titik kegagalan. AI juga memberikan gambaran solusi seperti pemisahan service dan load balancing serta trade-off dari solusi tersebut. | Saran AI digunakan sebagai bahan pemahaman dan kerangka awal. Analisis kemudian disesuaikan dengan skenario FoodGo dan ditulis kembali menggunakan bahasa sendiri, terutama pada bagian dampak, solusi, dan trade-off. |
